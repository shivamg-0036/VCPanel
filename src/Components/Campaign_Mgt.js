            ...
            <div className="content-body mb-0" >
                <div className="">
                    <div className="col-12 pr-0"  >
                        <div className="card mb-1" style={{ boxShadow: "0 0px 12px rgba(8, 70, 243, 0.4)" }} >
                        ...
                        <div style={{ display: "flex", flex: "0 0 100%", maxWidth: "100%", overflowY: "auto" }} >
                            <div className='card card-left mb-0 py-1 px-2 ' style={{ boxShadow: "0 0px 12px rgba(8, 70, 243, 0.4)" }} >
                                ...
                                <ul class="nav nav-tabs" style={{ fontSize: '0.8rem', width: "100%" }}>
                                ...
                                {tabname === "Group" && <>
                                    ...
                                    <div className='row' style={{ display: "flex", flexWrap: "wrap", columnGap: "1.9rem", justifyContent: "flex-start", marginTop:"0.3rem" }}>
                                    ...
                                    <div>
                                        ...
                                        {isgroupschedulemsg === "Yes" && <div style={{ display: "block", marginTop: "-0.1rem", marginLeft: '2rem' }}>
                                            <div style={{ marginTop: '1.8rem' }}>
